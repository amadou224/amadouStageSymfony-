...
// Returns the private 'App\Repository\RoyalPalaceAllerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\RoyalPalaceAllerRepository.php';

return $this->privates['App\Repository\RoyalPalaceAllerRepository'] = new \App\Repository\RoyalPalaceAllerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
